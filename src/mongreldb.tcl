...
package provide mongreldb 0.64.14
...
namespace eval ::mongreldb {
    ...
    namespace export connect health tables createTable dropTable count \
                          ...
                          lastEpoch retrieveText queryStatus cancelQuery \
                          parseCommitHlc parseQueryStatus
}
...
proc ::mongreldb::_request {db method path {body {}}} {
    ...
    ::http::config -useragent "mongreldb-tcl/0.64.14"
...
source [file join [file dirname [info script]] durable.tcl]
